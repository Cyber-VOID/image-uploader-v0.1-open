            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-64">
                <div class="bg-transparent dark:bg-transparent overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="rounded-lg  p-8 shadow-lg lg:col-span-3 lg:p-12" style="background: #1F2937">
                        <form action="{{ route('images.new-post') }}" method="post" class="space-y-4" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div>
                                    <label class="sr-only" for="collection_name">Image Name </label>
                                    <input
                            ...
                            <div class="grid place-items-center">
                                <div
                                    ...
                                    <input type="file" id="imgs" name="img" accept="image/jpeg"
                                           multiple
